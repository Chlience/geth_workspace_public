...
mv logs_simu/elastic_pre_sjf_simulation_seed_26_task_20 logs_simu/elasgnn.log
mv logs_simu/sjf_simulation_seed_26_task_20 logs_simu/sjf.log
mv logs_simu/fifo_simulation_seed_26_task_20 logs_simu/yarn-cs.log
